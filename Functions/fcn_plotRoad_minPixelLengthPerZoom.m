...
% FORMAT:
%
%       [zoomLevels, minMetersPerPixel, minDegPerPixelLon, minDegPerPixelLat] = fcn_plotRoad_minPixelLengthPerZoom((mapCenterLatitude), (figNum))
%
% INPUTS:
%
%      (OPTIONAL INPUTS)
...
% EXAMPLES:
%
%   [z,mpp] = fcn_plotRoad_minPixelLengthPerZoom;
