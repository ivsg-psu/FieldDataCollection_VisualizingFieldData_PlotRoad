function fcn_plotRoad_plotHeadTailLL(LLdata, figNum, varargin)
...
if flag_do_plots
    ...
    fcn_plotRoad_plotLL(LLdata(1,:), (tempPlotFormat), (figNum));
    ...
    tempPlotFormat.LineStyle = 'none';
    fcn_plotRoad_plotLL(LLdata(end,:), (tempPlotFormat), (figNum));
    ...
    if length(LLdata(:,1))>4
        ...
        fcn_plotRoad_plotLL(LLdata(1:2,:), (tempPlotFormat), (figNum));
        ...
        tempPlotFormat.Marker = 'none';
        tempPlotFormat.LineStyle = '-';
        fcn_plotRoad_plotLL(LLdata(end-1:end,:), (tempPlotFormat), (figNum));
        ...
        tempPlotFormat.Marker = 'none';
        tempPlotFormat.LineStyle = '-';
        fcn_plotRoad_plotLL(LLA_vector, (tempPlotFormat), (figNum));
