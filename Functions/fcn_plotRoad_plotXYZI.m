...
% FORMAT:
%
%      [h_geoplot, indiciesInEachPlot] = fcn_plotRoad_plotXYZI(XYZIdata, (plotFormat), (colorMap), (figNum))
%
% INPUTS:  
%
...
if flag_do_plots
    ...
    for ith_color = 1:Ncolors
        ...
        if ~isempty(plotting_indicies)
            ...
            % Do the plotting
            h_plot(ith_color,1)  = fcn_plotRoad_plotXYZ([X_data_selected Y_data_selected Z_data_selected], (tempPlotFormat), (figNum));
